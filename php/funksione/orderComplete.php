...
<body>
  ...
  <h1>Porosia u krye me sukses</h1>
   ...
   <h3>Emri produktit: <?php echo$_SESSION['emriProduktit']?></h3>
   <img src="../../img/products/<?php echo $_SESSION['fotoProduktit']?>">
   <p><strong>Qmimi Produktit</strong><?php echo $_SESSION['qmimiProduktit']?></p>
   <p><strong>Sasia</strong><?php echo $_SESSION['sasia']?></p>
   <p><strong>Qmim pa Transport</strong><?php echo $_SESSION['sasia']*$_SESSION['qmimiProduktit']?></p>
   <p><strong>Qmimi transportit</strong> 2</p>
   <p><strong>Qmimi Total</strong><?php echo $_SESSION['qmimiProduktit']*$_SESSION['sasia']+2?></p>
    </div>
   
   <div class="detajetDorezimit">

   <h2>Detajet e dorezimit</h2>
   <p><strong>Emri</strong><?php echo $_SESSION['emri']?></p>
   <p><strong>Mbeimri</strong><?php echo $_SESSION['mbiemri']?></p>
   <p><strong>Tel</strong><?php echo $_SESSION['tel']?></p>
   <p><strong>Email</strong><?php echo $_SESSION['email']?></p>
   <p><strong>Qyteti</strong><?php echo $_SESSION['qyteti']?></p>
   <p><strong>Adresa</strong><?php echo $_SESSION['adresa']?></p>
   <h3>Paguani pas pranimit te porosis</h3>
   <h4>Porosia arrin me se largu <?php echo date("d-m-y", strtotime("+3 days", strtotime(date("d-m-y"))))?></h4>
   </div>
   <a href=""><button >Perfundo</button></a>
  </div>
